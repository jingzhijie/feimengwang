      ...
      <div class="coursebanner">
        <div class="content">
          <!-- <swiper :options="swiperOption">
            <swiper-slide v-for="(item,index) in courseData.recommend" :key = 'index'><div class="txt">{{item.title}}</div><img :src="baseurl + item.thumb" alt=""></swiper-slide>
...
export default {
  ...
  methods: {
    getCourse() {
      ...
      axios.get(Global.baseURL + '/Mobile/Index/course.html').then((response) => {
